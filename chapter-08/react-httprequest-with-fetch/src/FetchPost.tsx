/**
 * A React component that demonstrates how to perform a basic POST request using the Fetch API.
 ...
 * The component maintains the list of users and any fetch errors in its state.
...
export function FetchPost() {
  ...
  function addUser(data: User): void {
    fetch("https://api.restful-api.dev/objects", {
      ...
      .then((json) => setUserList((users) => [...users, json as User]))
