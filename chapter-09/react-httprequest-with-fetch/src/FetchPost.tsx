/**
 * A React component that demonstrates how to
 * perform a basic POST request using the Fetch API.
 * It allows users to add new user objects to a public API
 * and displays the updated list of users.
...
/**
 * Type definition for a User object returned by the API.
 */
interface User {
  id?: string;
  name: string;
...
export function FetchPost() {
  ...
  function addUser(data: User): void {
    fetch("https://api.restful-api.dev/objects", {
      ...
      .then((json) => {
        setUserList((users) => [...users, json as User]);
      })
      .catch((error: unknown) => {
