 ...
 * The child employs `useEffect` with specific dependencies, setting up a cleanup
 * that triggers on dependency changes.
 */
import { useRef, useState } from "react";
import { ChildComponentCleanupFnDepArray } from "./ChildComponentCleanupFnDepArray";

export function ParentComponentCleanupFnDepArray() {
  ...
  return (
    <>
      <div className="my-box-border-1">
        ...
        <div className="my-box-border-1">
          {isChildMount ? (
            <ChildComponentCleanupFnDepArray
              onLifecycleEvent={logLifecycleEvent}
            />
          ) : (
