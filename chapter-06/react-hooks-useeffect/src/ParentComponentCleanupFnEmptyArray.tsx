...
import { ChildComponentCleanupFnEmptyArray } from "./ChildComponentCleanupFnEmptyArray";

export function ParentComponentCleanupFnEmptyArray() {
  ...
  return (
    <>
      <div className="my-box-border-1">
        ...
        <div className="my-box-border-1">
          {isChildMount ? (
            <ChildComponentCleanupFnEmptyArray
