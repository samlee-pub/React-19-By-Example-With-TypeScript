 ...
 * The child uses `useEffect` without dependencies, causing its cleanup function
 * to execute after every render.
 */
import { useRef, useState } from "react";
import { ChildComponentCleanupFnNoArray } from "./ChildComponentCleanupFnNoArray";

export function ParentComponentCleanupFnNoArray() {
  ...
  return (
    <>
      <div className="my-box-border-1">
        ...
        <div className="my-box-border-1">
          {isChildMount ? (
            <ChildComponentCleanupFnNoArray
