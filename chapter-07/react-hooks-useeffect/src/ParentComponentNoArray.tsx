 ...
 * The child uses `useEffect` without dependencies, causing side effects
 * to execute after every render cycle.
 */
import { useRef } from "react";
import { ChildComponentNoArray } from "./ChildComponentNoArray";

export function ParentComponentNoArray() {
  ...
  return (
    <>
      <div className="my-box-border-1">
        ...
        <div className="my-box-border-1">
          <ChildComponentNoArray onLifecycleEvent={logLifecycleEvent} />
        </div>
      </div>
